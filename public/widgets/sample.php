...
class Pm_My_Recent_Posts_Widget extends WPH_Widget {
	/**
	...
	function __construct() {
		...
		$args = array(
			'label' => __( 'My Recent Posts Example', PM_TEXTDOMAIN ),
			'description' => __( 'My Recent Posts Widget Description', PM_TEXTDOMAIN ),
		);
		...
		$args[ 'fields' ] = array(
			...
			array(
				...
				'class' => 'widefat',
				// Default value						
				'std' => __( 'Recent Posts', PM_TEXTDOMAIN ),
				/**
			...
			array(
				// Field name/label									
				'name' => __( 'Taxonomy', PM_TEXTDOMAIN ),
				// Field description					
				'desc' => __( 'Set the taxonomy.', PM_TEXTDOMAIN ),
				// Field id		
				'id' => 'taxonomy',
				'type' => 'taxonomy',
				// Class, rows, cols								
			...
			array(
				// Field name/label									
				'name' => __( 'Taxonomy terms', PM_TEXTDOMAIN ),
				// Field description					
				'desc' => __( 'Set the taxonomy terms.', PM_TEXTDOMAIN ),
				// Field id		
				'id' => 'taxonomyterm',
				'type' => 'taxonomyterm',
				'taxonomy' => 'category',
			...
			array(
				// Field name/label									
				'name' => __( 'Pages', PM_TEXTDOMAIN ),
				// Field description					
				'desc' => __( 'Set the page.', PM_TEXTDOMAIN ),
				// Field id		
				'id' => 'pages',
				'type' => 'pages',
				// Class, rows, cols								
			...
			array(
				// Field name/label									
				'name' => __( 'Post type', PM_TEXTDOMAIN ),
				// Field description					
				'desc' => __( 'Set the post type.', PM_TEXTDOMAIN ),
				// Field id		
				'id' => 'posttype',
				'type' => 'posttype',
				'posttype' => 'post',
			...
			array(
				'name' => __( 'Amount' ),
				'desc' => __( 'Select how many posts to show.', PM_TEXTDOMAIN ),
				'id' => 'amount',
				'type' => 'select',
				// Selectbox fields			
				'fields' => array(
					array(
						// Option name
						'name' => __( '1 Post', PM_TEXTDOMAIN ),
						// Option value			
						'value' => '1'
					),
					array(
						'name' => __( '2 Posts', PM_TEXTDOMAIN ),
						'value' => '2'
					),
					array(
						'name' => __( '3 Posts', PM_TEXTDOMAIN ),
						'value' => '3'
					)
				// Add more options
				),
			...
			array(
				'name' => __( 'Output as list', PM_TEXTDOMAIN ),
				'desc' => __( 'Wraps posts with the <li> tag.', PM_TEXTDOMAIN ),
				'id' => 'list',
				'type' => 'checkbox',
				// Checked by default: 
				'std' => 1, // 0 or 1
...
// Register widget
if ( !function_exists( 'pm_my_register_widget' ) ) {
	/**
	 * Initialize the widget
	 * 
	 * @return void
	 */
	function pm_my_register_widget() {
		register_widget( 'Pm_My_Recent_Posts_Widget' );
	}
	add_action( 'widgets_init', 'pm_my_register_widget', 1 );
}
